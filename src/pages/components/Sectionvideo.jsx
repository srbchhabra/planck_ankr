  ...
  return (
    <>
      <div className="relative h-[120vh] bg-[url(/globeglobe.png)] bg-contain bg-no-repeat ">
        <div>
        {/* Content overlay */}
        <motion.div initial={{opacity:0,y:800}} animate={{opacity:1, y: 0}} transition={{duration:1}}  className="absolute w-full  inset-0 flex flex-col items-center bg-cover  text-center text-white">
